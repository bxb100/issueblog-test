...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <div class="top inner">
            This is a Podcast RSS Feed generated by <a href="https://github.com/bxb100/issueblog" target="_blank">Issueblog Action</a>.
            Podcast apps can use the URL in the address bar. see more in 
            <a href="https://moon.fm/" target="_blank">
              moon.fm</a>.
          </div>
